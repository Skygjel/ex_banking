defmodule ExBanking do
  ...
  def create_user(user_name) when is_binary(user_name) do
    ManagerWorkSplitter.add_user(user_name)
  end
  ...
  def deposit(user_name, amount, currency)
    ...
    ManagerWorkSplitter.schedule_work({:deposit, user_name, [amount, currency]})
  end
  ...
  def balance(user_name, currency) when is_binary(user_name) and is_binary(currency) do
    ManagerWorkSplitter.schedule_work({:balance, user_name, [currency]})
  end
